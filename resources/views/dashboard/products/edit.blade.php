            ...
            @csrf
              ...
              @foreach (config('translatable.locales') as $locale)
                <div class="form-group col-md-8">
                    ...
                    <input type="text" name="{{$locale}}[name]" value="{{$product->translate($locale)->name}}" class="form-control" id="exampleInputEmail1">
                    @error("$locale.name")
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                  </div>
                  ...
                  <div class="form-group col-md-8">
                    ...
                    <textarea name="{{$locale}}[description]" class="form-control ckeditor" id="editor"> {{$product->translate($locale)->description}} </textarea>
